  ...
  return (
    <header
      ...
      style={{
        ...
        background: "color-mix(in srgb, var(--bg-surface) 94%, transparent)", backdropFilter: "blur(20px)",
      ...
      {showBrand ? (
        ...
        <span style={{ fontFamily: "Hanken Grotesk", fontWeight: 800, fontSize: 20, color: "var(--text-primary)" }}>
          {title}
        </span>
      )}
