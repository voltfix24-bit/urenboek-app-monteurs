...
export function MedewerkerSkeleton() {
  return (
    <div className="rounded-2xl p-3.5 flex items-center gap-3" style={{ background: "#ffffff", border: "1px solid #e5e7eb" }}>
...
export function KpiSkeleton() {
  return (
    <div className="rounded-2xl p-3 text-center space-y-2" style={{ background: "#ffffff", border: "1px solid #e5e7eb" }}>
...
export function GoedkeuringCardSkeleton() {
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: "#ffffff", border: "1px solid #e5e7eb" }}>
      <div className="flex items-center gap-2.5 px-4 py-3" style={{ background: "#ffffff" }}>
        <SkeletonBase style={{ width: 32, height: 32, borderRadius: "50%" }} />
        <div className="flex-1 space-y-1.5">
