...
export function MedewerkerSkeleton() {
  return (
    <div className="rounded-2xl p-3.5 flex items-center gap-3" style={{ background: "var(--bg-surface)", border: "1px solid var(--planning-border-soft)" }}>
...
export function KpiSkeleton() {
  return (
    <div className="rounded-2xl p-3 text-center space-y-2" style={{ background: "var(--bg-surface)", border: "1px solid var(--planning-border-soft)" }}>
