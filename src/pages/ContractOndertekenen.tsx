  ...
  if (klaar && accountAangemaakt) return (
    <CenterLayout>
      <div className="text-center space-y-4">
        ...
        <div className="rounded-xl p-3 mt-4" style={{ background: "var(--bg-surface)", border: "1px solid var(--planning-border-soft)" }}>
    ...
    <div className="min-h-screen" style={{ background: "var(--app-navy)" }}>
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        {kandidaatEmail && kandidaatId && (
          <div className="rounded-2xl p-5 space-y-4" style={{ background: "var(--bg-surface)", border: "1px solid var(--planning-border-soft)" }}>
            <div>
            ...
            <div>
              ...
              <div className="w-full mt-1 rounded-lg p-2.5 text-sm"
                style={{ background: "var(--app-navy)", border: "1px solid var(--planning-border-soft)", color: "var(--text-muted)" }}>
                {kandidaatEmail}
              </div>
            </div>
        ...
        <div className="rounded-xl p-3 mt-6 text-center" style={{ background: "var(--bg-surface)", border: "1px solid var(--planning-border-soft)" }}>
          <p className="text-xs font-semibold" style={{ color: "var(--text-primary)" }}>TerreVolt B.V.</p>
          <p className="text-xs" style={{ color: "var(--text-muted)" }}>info@terrevolt.nl</p>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        {stap === 1 && !showCorrectie && (
          <div className="space-y-4">
            ...
            <button onClick={() => setStap(2)} className="w-full py-3 rounded-xl text-sm font-semibold" style={{ background: "var(--accent)", color: "var(--on-accent)" }}>
          ...
          <div className="space-y-4">
              ...
              {CORRECTIE_OPTIES.map(opt => (
                <button
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${correctieItems.includes(opt.key) ? "var(--accent-border)" : "var(--planning-border-soft)"}`,
                    color: correctieItems.includes(opt.key) ? "var(--accent)" : "var(--text-muted)",
                ...
                >
                  <span className="w-5 h-5 rounded border-2 flex items-center justify-center shrink-0 text-xs"
                    style={{
                      borderColor: correctieItems.includes(opt.key) ? "var(--accent)" : "var(--planning-border-soft)",
            ...
            <div>
              ...
              <textarea
                ...
                style={{ background: "var(--bg-surface)", border: "1px solid var(--planning-border-soft)", color: "var(--text-primary)", minHeight: 100 }}
              />
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 mb-2">
              <div className="flex-1 h-1.5 rounded-full overflow-hidden" style={{ background: "var(--bg-surface-2)" }}>
                <div className="h-full rounded-full transition-all" style={{ width: `${scrollPercent}%`, background: scrollPercent >= 95 ? "var(--accent)" : "var(--accent)" }} />
              </div>
            ...
            <div ref={scrollRef} onScroll={handleScroll}
              ...
              style={{ background: "var(--bg-surface)", border: "1px solid var(--planning-border-soft)", maxHeight: 400, color: "var(--text-muted)" }}>
            ...
            <div className="flex gap-2">
              <button onClick={() => setStap(1)} className="flex-1 py-3 rounded-xl text-sm" style={{ border: "1px solid var(--planning-border-soft)", color: "var(--text-muted)" }}>← Vorige</button>
              <button onClick={() => setStap(3)} disabled={!gelezen}
                className="flex-1 py-3 rounded-xl text-sm font-semibold"
                style={{ background: gelezen ? "var(--accent)" : "var(--bg-surface-2)", color: gelezen ? "var(--on-accent)" : "var(--text-muted)" }}>
                Ondertekenen →
              </button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input value={naam} onChange={e => setNaam(e.target.value)} placeholder="Typ je volledige naam"
                className="w-full mt-1 rounded-lg p-2.5 text-sm" style={{ background: "var(--bg-surface)", border: "1px solid var(--planning-border-soft)", color: "var(--text-primary)" }} />
            ...
            <div className="flex gap-2">
              <button onClick={() => setStap(2)} className="flex-1 py-3 rounded-xl text-sm" style={{ border: "1px solid var(--planning-border-soft)", color: "var(--text-muted)" }}>← Vorige</button>
