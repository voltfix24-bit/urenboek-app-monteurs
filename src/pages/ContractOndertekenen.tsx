...
export default function ContractOndertekenen() {
  ...
  useEffect(() => {
    async function load() {
      ...
      // Look up contract by token stored in contract_data
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        {stap === 1 && (
          <div className="space-y-4">
            ...
            <a href="mailto:info@terrevolt.nl" className="text-xs underline block text-center" style={{ color: "var(--text-muted)" }}>
              ✏ Klopt er iets niet? Stuur een bericht
            </a>
