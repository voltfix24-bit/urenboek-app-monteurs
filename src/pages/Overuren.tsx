...
const TYPE_CONFIG: Record<string, { label: string; bg: string; color: string }> = {
  dag_overschrijding: { label: "Dag > 8u", bg: "var(--warn-bg)", color: "var(--warn-text)" },
  week_overschrijding: { label: "Week > 40u", bg: "var(--info-light)", color: "var(--info)" },
                ...
                {isDone ? (
                  <div className="space-y-1">
                    <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full" style={{
                      background: m.status === "goedgekeurd" ? "var(--success-light)" : "var(--danger-light)",
                      color: m.status === "goedgekeurd" ? "var(--success)" : "var(--danger)",
                    }}>
