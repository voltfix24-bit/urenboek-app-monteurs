...
const SURFACE_2 = "var(--bg-surface-2)";
const GREEN = "var(--accent)";
const GREEN_DARK = "var(--accent)";
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          marginBottom: 28, boxShadow: "0 20px 60px var(--accent-border)",
          position: "relative", zIndex: 1,
        }}>
          <span className="material-symbols-outlined" style={{
            fontSize: 56, color: "var(--accent-dark)", fontVariationSettings: "'FILL' 1",
          }}>check_circle</span>
        </div>

        <h1 style={{
          fontFamily: "Hanken Grotesk", fontWeight: 800, fontSize: 32, color: TEXT,
          marginBottom: 12, textAlign: "center", position: "relative", zIndex: 1,
        }}>
          Aanvraag verstuurd!
        </h1>
        <p style={{
          fontFamily: "Hanken Grotesk", fontSize: 14, color: MUTED, textAlign: "center",
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: `linear-gradient(135deg, ${GREEN}, ${GREEN_DARK})`,
              border: "none", color: "var(--accent-dark)", fontFamily: "Hanken Grotesk",
              fontWeight: 800, fontSize: 16, cursor: "pointer",
              boxShadow: "0 12px 40px var(--accent-border)",
            }}>
        ...
        <div style={{
          ...
          <div style={{ background: SURFACE_2, borderRadius: 14, padding: "14px 16px" }}>
            <p style={{
              fontSize: 9, fontWeight: 700, color: SUBTLE, fontFamily: "Hanken Grotesk",
    ...
    <div style={{
      ...
      <style>{`
        ...
        .verlof-cal .rdp-caption_label {
          font-family: 'Hanken Grotesk', sans-serif; font-weight: 800; font-size: 17px;
        ...
        .verlof-cal .rdp-nav_button:hover { background: var(--accent-light); }
        .verlof-cal .rdp-nav_button:active { transform: scale(0.94); }
        .verlof-cal .rdp-head_cell {
          color: ${MUTED}; font-family: 'Hanken Grotesk', sans-serif;
        ...
        .verlof-cal .rdp-day_range_end {
          ...
          box-shadow: 0 6px 18px color-mix(in srgb, var(--accent) 35%, transparent), inset 0 0 0 2px color-mix(in srgb, var(--bg-surface) 80%, transparent) !important;
          z-index: 1;
          position: relative;
        }
      ...
      <header style={{
        ...
        <h1 style={{
          fontFamily: "Hanken Grotesk", fontWeight: 800, fontSize: 20, color: TEXT,
      ...
      <main style={{
        ...
        <section style={{ background: SURFACE, borderRadius: 20, padding: 20 }}>
          <p style={{
            fontSize: 10, fontWeight: 700, color: SUBTLE, fontFamily: "Hanken Grotesk",
            ...
            {(["vakantie", "verlof", "anders"] as const).map(t => (
              <button
                ...
                style={{
                  ...
                  color: type === t ? "var(--accent-dark)" : MUTED,
                  fontFamily: "Hanken Grotesk", fontWeight: 700, fontSize: 13,
                  cursor: "pointer", textTransform: "capitalize",
                  boxShadow: type === t ? "0 4px 12px var(--accent-border)" : "none",
        ...
        <section style={{ background: SURFACE, borderRadius: 20, padding: "20px 12px 16px" }}>
          <div style={{ padding: "0 8px 12px", display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
            <div>
              ...
              <p style={{
                fontFamily: "Hanken Grotesk", fontSize: 12, color: MUTED, lineHeight: 1.4,
              }}>
            ...
            {(range?.from || range?.to) && (
              <button
                ...
                style={{
                  ...
                  color: "var(--danger)", fontFamily: "Hanken Grotesk",
          ...
          {validatieFout && (
            <div style={{
              ...
              background: "var(--danger-light)", border: "1px solid rgba(255,113,108,0.35)",
              display: "flex", alignItems: "flex-start", gap: 10,
            }}>
              <span className="material-symbols-outlined" style={{ fontSize: 18, color: "var(--danger)", flexShrink: 0, marginTop: 1 }}>error</span>
              <p style={{ fontFamily: "Hanken Grotesk", fontSize: 12, color: "var(--danger)", fontWeight: 600, lineHeight: 1.4 }}>
                {validatieFout}
              </p>
            </div>
          )}
          ...
          {isValid && range?.from && range?.to && (
            <div style={{
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                <p style={{
                  fontFamily: "Hanken Grotesk", fontWeight: 800, fontSize: 15, color: TEXT,
                ...
                <p style={{
                  fontFamily: "Hanken Grotesk", fontSize: 12, color: MUTED, fontWeight: 600,
                }}>
                  {aantalDagen} {aantalDagen === 1 ? "dag" : "dagen"}
        ...
        <section style={{ background: SURFACE, borderRadius: 20, padding: 20 }}>
          ...
          <textarea
            ...
            style={{
              ...
              padding: "14px", color: TEXT, fontFamily: "Hanken Grotesk", fontSize: 13,
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            border: "none", color: isValid ? "var(--accent-dark)" : SUBTLE,
            fontFamily: "Hanken Grotesk", fontWeight: 800, fontSize: 15,
            letterSpacing: "0.01em",
            cursor: isValid && !sending ? "pointer" : "not-allowed",
            opacity: sending ? 0.6 : 1,
            boxShadow: isValid ? "0 12px 40px color-mix(in srgb, var(--accent) 25%, transparent)" : "none",
            transition: "all 0.2s",
          }}>
